<html lang="en">
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .hidden-bottom { 
    opacity: 0;              /* จางออก */
    pointer-events: none;    /* ไม่สามารถคลิก */
    transition: opacity 0.5s ease;  /* กำหนดความเร็วการ fade */
}
